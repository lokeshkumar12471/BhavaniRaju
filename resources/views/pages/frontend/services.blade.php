<x-guest-layout>
    <!-- Start -->
    <section class="relative md:py-24 py-16 mt-6" id="multispeciality">
        <div class="container">
            <div class="grid grid-cols-1 pb-8 text-center">
                <h3 class="mb-6 md:text-3xl text-2xl md:leading-normal leading-normal font-medium  dark:text-white">
